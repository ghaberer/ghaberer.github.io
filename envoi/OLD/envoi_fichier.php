...
<div id="maintext">
  ...
  <p>
  Sélectionnez votre fichier, précisez vos noms et prénoms, puis
  cliquez sur le bouton d'envoi.
  </p>
	  
  <p>
  <!-- le formulaire d'envoi proprement dit -->
  <form method="post" action="envoi_fichier.php" enctype="multipart/form-data">

  <h2>Sélection du fichier &agrave; envoyer</h2>

  <!-- <SELECT name="nomTD" size="1"> -->
  <!--   <OPTION value="501">TP 501</OPTION> -->
  <!--   <OPTION value="502">TP 502</OPTION> -->
  <!--   <OPTION value="503">TD 503</OPTION> -->
  <!--   <OPTION value="504" selected>TP 504</OPTION> -->
  <!--   <OPTION value="505">TP 505</OPTION> -->
  <!--   <OPTION value="506">TP 506</OPTION> -->
  <!--   <OPTION value="507">TP 507</OPTION> -->
  <!--   <OPTION value="508">TP 508</OPTION> -->
  <!--   <OPTION value="509">TP 509</OPTION> -->
  <!-- </SELECT> -->
