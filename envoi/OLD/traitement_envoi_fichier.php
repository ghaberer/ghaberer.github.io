...
elseif ($_FILES['fichier']['size']>100000 OR $_FILES['fichier']['error']==1)
	{
...
/*  		$formulaire_valide = False;  */
/*  	}  */
elseif ((pathinfo($_FILES['fichier']['name'],PATHINFO_EXTENSION)!='py')&&(pathinfo($_FILES['fichier']['name'],PATHINFO_EXTENSION)!='sql'))  
 	{ 
 		$messageErreurFichier= 'Seuls les fichiers ".py" ou ".sql" sont acceptés dans ce formulaire. Vérifiez votre fichier .'; 
 		$formulaire_valide = False; 
 	} 
